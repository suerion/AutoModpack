...
public class Commands {
    ...
    // Prints the DNS TXT record to publish (in a DNSSEC-signed zone) so clients verify
    // and pin this server's certificate automatically on first join.
    private static int fingerprintDnsRecord(CommandContext<CommandSourceStack> context) {
        ...
        String record = DnsPinResolver.RECORD_PREFIX + host + ". IN TXT \"" + DnsPinResolver.RECORD_VERSION + ";fp=" + fingerprint + "\"";
